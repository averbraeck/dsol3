/**
 * Utility to clean the .classfile files for all projects; the excludes=** will be removed, and utilities to include
 * types in the javadoc for methods and constructors. <br>
 * <br>
 ...
 */
package nl.tudelft.simulation.buildtools;