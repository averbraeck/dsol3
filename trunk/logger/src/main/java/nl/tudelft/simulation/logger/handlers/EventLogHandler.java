...
public class EventLogHandler extends Handler implements EventProducerInterface
{
    ...
    public static final EventType LOG_RECORD_PRODUCED_EVENT = new EventType(
     ...
     */
    public boolean addListener(final EventListenerInterface listener,
     ...
     */
    public boolean addListener(final EventListenerInterface listener,
            final EventType eventType, final boolean weak)
    {
     ...
     */
    public boolean addListener(final EventListenerInterface listener,
            final EventType eventType, final short position)
    {
     ...
     */
    public boolean addListener(final EventListenerInterface listener,
            final EventType eventType, final short position, final boolean weak)
    {
    ...
    {
        this.postman.fireEvent(new Event(
                EventLogHandler.LOG_RECORD_PRODUCED_EVENT, this, this
                        .getFormatter().format(arg0)));
    }
     ...
     *      nl.tudelft.simulation.event.EventType)
     */
    public boolean removeListener(final EventListenerInterface listener,
            final EventType eventType)
    {
