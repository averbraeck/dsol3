...
public interface RemoteContextListenerInterface extends Remote
{
     ...
     * <p>
     * The binding of the renamed object can be obtained using <tt>evt.getNewBinding()</tt>. Its old binding (before the rename)
     * can be obtained using <tt>evt.getOldBinding()</tt>. One of these may be null if the old/new binding was outside the scope
     ...
     * <p>
     * The binding of the changed object can be obtained using <tt>evt.getNewBinding()</tt>. Its old binding (before the change)
