/*
 * @(#) FSTORE.java $Date: 2010/08/10 11:38:20 $ Copyright (c) 2002-2005 Delft
...
/**
 * The FSTORE operation as defined in <a
...
public class FSTORE extends VoidOperation
{
     ...
     * @throws IOException on IOfailure
     */
    public FSTORE(final DataInput dataInput, final boolean widened)
            throws IOException
    {
        super();
