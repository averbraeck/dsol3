/*
 * @(#) ISTORE.java $Date: 2010/08/10 11:38:22 $ Copyright (c) 2002-2005 Delft
...
/**
 * The ISTORE operation as defined in <a
...
public class ISTORE extends VoidOperation
{
     ...
     * @throws IOException on IOfailure
     */
    public ISTORE(final DataInput dataInput, final boolean widened)
            throws IOException
    {
        super();
