/*
 * @(#) DLOAD.java $Date: 2010/08/10 11:38:20 $ Copyright (c) 2002-2005 Delft
...
/**
 * The DLOAD operation as defined in <a
...
public class DLOAD extends VoidOperation
{
     ...
     * @throws IOException on IOfailure
     */
    public DLOAD(final DataInput dataInput, final boolean widened)
            throws IOException
    {
        super();
