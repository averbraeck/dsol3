/*
 * @(#) ASTORE.java $Date: 2010/08/10 11:38:24 $ Copyright (c) 2002-2005 Delft
...
/**
 * The ASTORE operation as defined in <a
...
public class ASTORE extends VoidOperation
{
     ...
     * @throws IOException on IOfailure
     */
    public ASTORE(final DataInput dataInput, final boolean widened)
            throws IOException
    {
        super();
