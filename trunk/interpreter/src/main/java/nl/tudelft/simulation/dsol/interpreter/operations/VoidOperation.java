...
/**
 * The VoidOperation is an abstract class for all operations which do not return
 * any value. The VoidOperation only pops and pushes from the stack.
 * <p>
...
public abstract class VoidOperation extends Operation
{
     ...
     */
    public abstract void execute(final OperandStack stack,
