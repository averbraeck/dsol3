/*
 * @(#) CUSTOMINVOKEVIRTUAL.java $Date: 2010/08/10 11:38:24 $ Copyright (c)
...
/**
 * The CUSTOMINVOKEVIRTUAL operation as defined in <a
 ...
 * @since 1.5
 */
public class CUSTOMINVOKEVIRTUAL
        extends
