...
public class HLAModel extends DSOLFederateAmbassador implements ModelInterface
{
            ...
            final RTIAmbassador rtiAmbassador, final Hashtable environment)
    {
        ...
        try
        {
            ...
            this.federateHandle = this.rtiAmbassador.joinFederationExecution(
                    environment.get("rti.federation.type").toString(),
            ...
            //Lookahaed
            this.rtiAmbassador.enableTimeRegulation(new LogicalTimeDouble(0.0),
                    new LogicalTimeIntervalDouble(0),false);
            ...
            throws SimRuntimeException
    {
        try
        {
            ...
            this.rtiAmbassador
                    .synchronizationPointAchieved(READY_TO_RUN, false);
    ...
    public static void main(String[] args)
    {
        ...
        {
            System.out
                    .println("java HLAModel [rti.properties.file] [experiment]");
            System.exit(0);
        }
        try
        {
            ...
            int port = Integer.valueOf(properties.get("rti.port").toString())
                    .intValue();
            RTIAmbassador rtiAmbassador = new RTIAmbassador(RTI
                    .getRTIambassador(host, port));

            Experiment experiment = ExperimentParser
                    .parseExperiment(URLResource.getResource(args[1]));
            HLAModel model = new HLAModel(experiment.getModel(), rtiAmbassador,
                    properties);
