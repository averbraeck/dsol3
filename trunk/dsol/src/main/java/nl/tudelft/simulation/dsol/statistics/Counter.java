 ...
 */
public class Counter extends nl.tudelft.simulation.jstats.statistics.Counter
{
     ...
     */
    public Counter(final String description, final SimulatorInterface simulator) throws RemoteException
    {
        super(description);
     ...
     * @throws RemoteException on network failure
     */
    public Counter(final String description, final SimulatorInterface simulator, final EventProducerInterface target,
