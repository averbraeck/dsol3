...
public class ContextUtil
{
     ...
     * @return the new root
     */
    private static Context createSubContext(final Context root,
            final String element)
    {
        ...
        } catch (Exception exception)
        {
            ...
            {
                Logger.warning(ContextUtil.class, "createSubContext",
                        namingException);
            }
            return root;
        }
    ...
    /**
     * resolves the context with relative name on root. If the context does not
     * exist it is created.
     * 
