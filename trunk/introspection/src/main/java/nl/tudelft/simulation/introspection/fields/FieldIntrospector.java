 ...
 * implementation of the introspection interfaces. Its behavior adhers to the
 * following:
 * <ul>
 * <li>Properties are discovered by searching for an object's fields
 * (visibility neutral)</li>
 * <li>Property value are manipulated by setting field values (visibility
 * neutral)</li>
 * </ul>
 * <p>
 ...
 * declared fields only). (c) copyright 2002-2005-2004 <a
...
public class FieldIntrospector implements Introspector
{
    ...
    /**
     * Collect the fields for the given class, taking the preference for deep
    ...
    /**
     * Add fields of 'clasz' to the fieldList. Optionally iterate over the class
     * hierarchy.
     * 
     ...
     */
    private void addFields(final List<Field> fieldList, final Class< ? > clasz,
