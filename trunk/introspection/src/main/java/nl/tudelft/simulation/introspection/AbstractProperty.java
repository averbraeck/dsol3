...
{
    /**
     * Basic 'setValue' implementation. It is checked whether this property
     * contains a composite value. If so, the composite value of this property
     * is updated. Composite values are expected to be supplied as a {see
     * java.util.Collection}. If needed, array conversion takes place. If the
     * property is not composite, the value-setting is delegated to the
     * 'setRegularValue' method.
     * 
    ...
    public void setValue(final Object value)
    {
        ...
        if (!(value instanceof Collection))
        {
            throw new IllegalArgumentException(this
                    + "assign Collection values to composite properties");
        }
        if (this.getType().isArray())
        {
            Object[] array = (Object[]) Array.newInstance(getType()
                    .getComponentType(), 0);
        ...
        } else
        {
            synchronized (this.getInstance())
            {
                ...
                {
                    Logger.warning(this, "setValue", "could not empty "
                            + oldValues + "setValue method canceled");
                }
            }
        }
     ...
     * of {see java.util.Collection}, i.e. is a property with composite value.
     * 
