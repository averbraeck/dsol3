...
/**
 * The Bernouilli distribution. For more information on this distribution see <a
 * href="http://mathworld.wolfram.com/BernouilliDistribution.html">
...
public class DistBernoulli extends DistDiscrete
{
    ...
    /**
     * constructs a new Bernoulli distribution. Random occurence with two
     * possible outcomes; used to generate other discrete random variates.
     * 
    ...
    public DistBernoulli(final StreamInterface stream, final double p)
    {
        ...
        } else
        {
            throw new IllegalArgumentException(
                    "Error Exponential - p<0 or p>1 (p=" + p + ")");
        }
    }

    /**
     * draws the next value from the Bernoulli distribution. More information on
     * this distribution can be found at < a
