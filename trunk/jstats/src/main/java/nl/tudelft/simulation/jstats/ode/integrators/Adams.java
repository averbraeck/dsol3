 ...
 * href="http://mathworld.wolfram.com/AdamsMethod.html">
 * http://mathworld.wolfram.com/AdamsMethod.html </a>
 * <p>
...
public class Adams extends CachingNumericalIntegrator
{
     ...
     */
    public Adams(final double timeStep,
    ...
    /**
     * @see nl.tudelft.simulation.jstats.ode.integrators.CachingNumericalIntegrator
     *      #next(double)
     */
    @Override
    public double[] next(final double x)
    {
        ...
        double[] sum = super.add(super.multiply(-9, dy3), super.multiply(37,
                dy2), super.multiply(-59, dy1), super.multiply(55, dy0));
