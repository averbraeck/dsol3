/*
 * @(#) Adams.java Apr 21, 2004 Copyright (c) 2002-2005 Delft University of
...
/**
 * The Milne numerical estimator as described in <a
 * href="http://mathworld.wolfram.com/MilnesMethod.html">
...
public class Milne extends CachingNumericalIntegrator
{
     ...
     */
    public Milne(final double timeStep,
    ...
    public Milne(final double timeStep,
            final DifferentialEquationInterface equation,
            final short integrationMethod, final int startingSubSteps)
    {
        super(timeStep, equation, 4, integrationMethod, startingSubSteps);
    }

    /**
     * @see nl.tudelft.simulation.jstats.ode.integrators.CachingNumericalIntegrator#next(double)
     */
    @Override
    public double[] next(final double x)
    {
        ...
        double[] p = super.add(y3, super.multiply(4 * this.timeStep / 3.0,
                super.add(super.multiply(2.0, dy0), super.multiply(-1.0, dy1),
                        super.multiply(2.0, dy2))));

        // Now we compute the corrector
        return super.add(y1, super.multiply(this.timeStep / 3.0, super.add(
                super.multiply(1.0, dy1), super.multiply(4.0, dy0),
