...
public class RungeKuttaFehlberg extends NumericalIntegrator
{
    ...
    protected static double[] a = new double[] { 0d, 1d / 4d, 3d / 8d,
            12d / 13d, 1d, 1d / 2d };
    ...
    protected static double[] c = new double[] { 16d / 135d, 0d,
            6656d / 12825d, 28561d / 56430d, -9d / 50d, 2d / 55d };

    /** the parameters for c4_i, in y_n+1 = y_n + c4_1 k_1 + c4_2 k_2 + ... */
    protected static double[] c4 = new double[] { 25d / 216d, 0d,
            1408d / 2565d, 2197d / 4104d, -1d / 5d, 0d };
