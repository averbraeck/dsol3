 ...
 * eventproducer. This behavior includes adding and removing listeners for a
 * specific event type.
 * <p>
...
public interface EventProducerInterface
{
     ...
     * @return the success of adding the listener. If a listener was already
     ...
     */
    boolean addListener(EventListenerInterface listener, EventType eventType,
            boolean weak) throws RemoteException;
     ...
     * @return the success of adding the listener. If a listener was already
     *         added, or an illegal position is provided false is returned.
     * @throws RemoteException If a network connection failure occurs.
     * @see nl.tudelft.simulation.event.ref.WeakReference
     */
    boolean addListener(EventListenerInterface listener, EventType eventType,
            short position) throws RemoteException;
     ...
     */
    boolean addListener(EventListenerInterface listener, EventType eventType,
            short position, boolean weak) throws RemoteException;

    /**
     * returns all the eventTypes for which a listener can subscribe.
     * 
     * @return EventType[] returns the eventTypes for which listeners can
     *         subscribe.
     * @throws RemoteException If a network connection failure occurs.
     */
     ...
     * @return the success of removing the listener. If a listener was not
     *         subscribed false is returned.
     * @throws RemoteException If a network connection failure occurs.
     */
