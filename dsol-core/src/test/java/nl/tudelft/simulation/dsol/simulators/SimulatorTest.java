...
public class SimulatorTest
{
    ...
    static class TestScheduledInitMethods
    {
        ...
        {
            DEVSSimulator.TimeDouble simulator = new DEVSSimulator.TimeDouble("sim");
            TestModel model = new TestModel(simulator);
            ReplicationInterface.TimeDouble replication = new SingleReplication.TimeDouble("rep", 0.0, 0.0, 100.0);
    ...
    /** */
    static class TestModel extends AbstractDSOLModel.TimeDouble<DEVSSimulator.TimeDouble>
    {
        /** */
         ...
         */
        TestModel(final DEVSSimulator.TimeDouble simulator)
        {
            super(simulator);
            try
            {
