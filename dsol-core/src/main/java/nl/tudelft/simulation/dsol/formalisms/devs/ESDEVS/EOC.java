 ...
 */
public class EOC<A extends Comparable<A> & Serializable, R extends Number & Comparable<R>, T extends SimTime<A, R, T>, P>
{
     ...
     */
    public OutputPortInterface<A, R, T, P> getToPort()
    {
        return this.toPort;
    }
}
