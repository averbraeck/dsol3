...
public final class PTestSorter
{
    ...
    {
        TableModel unsorted =
                new DefaultTableModel(new Object[][]{{"fruit", "apple", new Integer(200), "1"},
                        {"car", "BMW 3", new Integer(1980), "2"}, {"nation", "America", new Integer(1776), "3"},
                        {"nation", "Germany", new Integer(1024), "4"}, {"nation", "England", new Integer(500), "5"},
                        {"nation", "Scotland", new Integer(1666), "6"}, {"nation", "Russia", new Integer(200), "7"},
                        {"nation", "France", new Integer(1789), "8"}, {"nation", "Belgium", new Integer(1820), "9"},
                        {"nation", "Pakistan", new Integer(1960), "10"}, {"nation", "Israel", new Integer(1945), "11"},
                        {"nation", "Palestina", new Integer(2004), "12"}, {"nation", "Iraq", new Integer(1300), "13"},
                        {"nation", "China", new Integer(-2000), "14"}, {"nation", "Peru", new Integer(-3000), "15"},
                        {"nation", "Nigeria", new Integer(-2000), "16"}}, new String[]{"category", "instance", "date",
                        "entry"});
