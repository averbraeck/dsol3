...
public abstract class AbstractTestDemoServer
{
                ...
                final HttpServletResponse response) throws IOException, ServletException
        {
            ...
            if (target.startsWith("/model.html"))
            {
                        ...
                        && !AbstractTestDemoServer.this.sessionWebModelMap.containsKey(sessionId))
                {
                    ...
                    DSOLModel.TimeDoubleUnit<SimulatorInterface.TimeDoubleUnit> model =
                    ...
                    try
                    {
                        Replication.TimeDoubleUnit newReplication = Replication.TimeDoubleUnit.create("rep 1", Time.ZERO,
                                Duration.ZERO, Duration.createSI(3600.0), model);
     ...
     */
    protected abstract DSOLModel.TimeDoubleUnit<SimulatorInterface.TimeDoubleUnit> instantiateModel(String modelId);
