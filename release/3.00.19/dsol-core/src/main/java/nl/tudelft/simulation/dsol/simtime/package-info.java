 ...
 * <p>
 * Each of the time classes supports basic operations on time, such as adding, subtracting, comparing, etc.. SimTime
 * is parameterized by three parameters:<br>
 ...
 * <li>SimTimeCalendarDouble: a simulation time that takes Calendar values with an underlying double to store the
 * time in milliseconds</li>
 * <li>SimTimeCalendarFloat: a simulation time that takes Calendar values with an underlying float to store the time
 * in milliseconds</li>
 * <li>SimTimeCalendarLong: a simulation time that takes Calendar values with an underlying long to store the time
 * in milliseconds</li>
