 ...
 */
public class EventPerformance implements DSOLModel
{
    ...
    public void constructModel(final SimulatorInterface.TimeDouble simulator) throws SimRuntimeException, RemoteException
    {
        ...
        devsSimulator.scheduleEvent(10000, this, this, "complete", new Object[]{new Long(System.currentTimeMillis())});
        for (int i = 0; i < 100000; i++)
        {
            devsSimulator.scheduleEvent(10000, this, this, "stepA", new Object[]{devsSimulator});
        }
    }
     ...
     */
    protected void stepA(final DEVSSimulatorInterface.TimeDouble simulator) throws SimRuntimeException, RemoteException
    {
        simulator.scheduleEvent(10, this, this, "stepB", null);
    }
