 ...
 */
public class IC<A extends Comparable<A>, R extends Number & Comparable<R>, T extends SimTime<A, R, T>, P>
{
     ...
     */
    public IC(final OutputPortInterface<A, R, T, P> fromPort, final InputPortInterface<A, R, T, P> toPort)
            throws Exception
    {
