...
/**
 * InputParameterMapDistDiscrete is a InputParameterMap with a long getDist() function. <br>
 * <br>
...
public abstract class InputParameterMapDistDiscrete extends InputParameterMap
{
     ...
     * @return DistDiscrete; the distribution function corresponding to the set parameters
     * @throws InputParameterException on error retrieving the values for the distribution
     */
    public abstract DistDiscrete getDist() throws InputParameterException;
