 ...
 */
public class Tally extends nl.tudelft.simulation.jstats.statistics.Tally
{
     ...
     */
    public Tally(final String description, final SimulatorInterface simulator) throws RemoteException
    {
        super(description);
     ...
     * @throws RemoteException on network failure.
     */
    public Tally(final String description, final SimulatorInterface simulator, final EventProducerInterface target,
