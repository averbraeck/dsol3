/*
 * @(#) LLOAD.java $Date: 2010/08/10 11:38:21 $ Copyright (c) 2002-2005 Delft
...
/**
 * The LLOAD operation as defined in <a
...
public class LLOAD extends VoidOperation
{
     ...
     * @throws IOException on IOfailure
     */
    public LLOAD(final DataInput dataInput, final boolean widened)
            throws IOException
    {
        super();
