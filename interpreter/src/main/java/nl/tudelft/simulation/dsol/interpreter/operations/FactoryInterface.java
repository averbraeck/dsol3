...
/**
 * The factoryInterface defines the required behavior for operation factories
 * mapping opcodes to operations.
 * <p>
...
public interface FactoryInterface
{
     ...
     */
    Operation readOperation(final DataInput dataInput,
     ...
     * @throws IOException on IOException
     */
    Operation readOperation(final int operand, final DataInput dataInput,
            final int startBytePosition) throws IOException;
}