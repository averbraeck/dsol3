...
public class ExperimentParser
{
     ...
     */
    private static double parsePeriod(final Element element, final TimeUnitInterface treatmentTimeUnit)
            throws Exception
    {
     ...
     * @throws Exception on failure
     */
    private static TimeUnitInterface parseTimeUnit(final String name) throws Exception
    {
        if (name.equals("DAY"))
        {
    ...
    private static Treatment parseTreatment(final Element element, final Experiment parent) throws Exception
    {
        ...
        {
            treatment.setWarmupPeriod(ExperimentParser.parsePeriod(element.getChild("warmupPeriod"),
                    treatment.getTimeUnit()));
        }
        if (element.getChild("runLength") != null)
        {
            treatment
                    .setRunLength(ExperimentParser.parsePeriod(element.getChild("runLength"), treatment.getTimeUnit()));
        }
