 ...
 * 
 * @author <a
 *         href="http://web.eur.nl/fbk/dep/dep1/Introduction/Staff/People/Lang"
 *         >Niels Lang </a><a href="http://www.peter-jacobs.com/index.htm">Peter
 *         Jacobs </a>
...
public final class PTestBeans
{
    ...
    {
        Property[] props = (new BeanIntrospector())
                .getProperties(new SubTestBean2());
        for (int i = 0; i < props.length; i++)
        {
            Logger.info(PTestBeans.class, "main", "Prop name: "
                    + props[i].getName());
            Logger.info(PTestBeans.class, "main", "Prop class: "
                    + props[i].getType());
            Logger.info(PTestBeans.class, "main", "Prop value: "
                    + props[i].getValue());
        }
    }
}