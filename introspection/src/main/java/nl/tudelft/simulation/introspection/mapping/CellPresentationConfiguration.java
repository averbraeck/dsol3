 ...
 * they should be assignable from {@link javax.swing.table.TableCellRenderer}
 * and
 * 
...
public interface CellPresentationConfiguration
{
     ...
     * configuration
     * 
     * @return A double class array of cardinality M-2. Tuple [i][j] defines M
     *         cell class - render class combinations, with 'i' identifying the
     *         row. 'j=0' identifies the cell class, 'j=1' identifies the
     *         renderer class.
     */
    Class[][] getRenderers();
     ...
     * 
     * @return A double class array of cardinality M-2. Tuple [i][j] defines M
     *         cell class - editor class combinations, with 'i' identifying the
     *         row. 'j=0' identifies the cell class, 'j=1' identifies the editor
     *         class.
     */
    Class[][] getEditors();
}