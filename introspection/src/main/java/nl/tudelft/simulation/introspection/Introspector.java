...
/**
 * The introspector provides introspection services, i.e. property discovery and
 * manipulation, for any object.
 * <p>
...
public interface Introspector
{
     ...
     * @return Retrieves properties of the introspected object. The properties'
     *         values can themselves be introspectable. An empty array is
     *         returned if no introspected object has been set.
     */
