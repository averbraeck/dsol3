...
/**
 * Manages the object model classes for an object model. Allows object models to
 * instantiate appropriate new object models.
 * 
 * @author Niels Lang
 */
public interface ModelManager
{
     ...
     */
    void setDefaultCollectionObjectTableModel(
            Class defaultCollectionObjectTableModel);
