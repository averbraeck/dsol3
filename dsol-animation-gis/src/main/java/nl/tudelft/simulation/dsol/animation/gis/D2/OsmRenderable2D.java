...
import nl.tudelft.simulation.dsol.animation.gis.mapfile.OsmFileParser;
...
public class OsmRenderable2D implements GisRenderable2D
{
     ...
     */
    public OsmRenderable2D(final SimulatorInterface<?, ?, ?> simulator, final URL mapFile)
    {
            ...
            final CoordinateTransform coordinateTransform, final double z)
    {
        ...
        try
        {
            this.map = OsmFileParser.parseMapFile(mapFile, coordinateTransform);
